...
_PBVOLUMETARGET.fields_by_name['duration'].message_type = protobuf_dot_types__pb2._PBDURATION
_PBVOLUMETARGET_PBVOLYMETARGETTYPE.containing_type = _PBVOLUMETARGET
_PBTRAININGLOAD.fields_by_name['recovery_time'].message_type = protobuf_dot_types__pb2._PBDURATION
...
_PBZONES.fields_by_name['heart_rate_setting_source'].enum_type = protobuf_dot_types__pb2._PBHEARTRATEZONESETTINGSOURCE
_PBZONES.fields_by_name['power_setting_source'].enum_type = protobuf_dot_types__pb2._PBPOWERZONESETTINGSOURCE
_PBZONES.fields_by_name['speed_setting_source'].enum_type = protobuf_dot_types__pb2._PBSPEEDZONESETTINGSOURCE
_PBBLEMAC.fields_by_name['type'].enum_type = protobuf_dot_types__pb2._PBMACTYPE
_PBRUNNINGINDEX.fields_by_name['calculation_time'].message_type = protobuf_dot_types__pb2._PBDURATION
_PBTRAININGSESSIONTARGETID.fields_by_name['last_modified'].message_type = protobuf_dot_types__pb2._PBSYSTEMDATETIME
_PBTRAININGSESSIONFAVORITEID.fields_by_name['last_modified'].message_type = protobuf_dot_types__pb2._PBSYSTEMDATETIME
_PBSWIMMINGPOOLINFO.fields_by_name['swimming_pool_type'].enum_type = protobuf_dot_types__pb2._PBSWIMMINGPOOLUNITS
...
PbVolumeTarget = _reflection.GeneratedProtocolMessageType('PbVolumeTarget', (_message.Message,), dict(
  ...
  __module__ = 'protobuf.structures_pb2'
